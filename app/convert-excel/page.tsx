...
export default function ComponentTxtAexcel() {
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col justify-center items-center bg-gradient-to-br from-[#23dce1] via-[#0057ff] to-[#23dce1] relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8" style={{marginTop: "-60px"}}>
        {/* Header with Logo */}
        <motion.div
