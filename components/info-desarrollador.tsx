    ...
    return (
        <>
            ...
            <motion.div
                ...
                animate={{ opacity: 1 }}
                transition={{ delay: 2 }}
                className={`fixed bottom-4 ${posicionBoton} z-50`}
            >
                <motion.div
            ...
            <AnimatePresence>
                {showInfo && (
                    <motion.div
                        className={`fixed bottom-16 ${posicionBoton} w-96 bg-gradient-to-br from-slate-800/95 to-slate-900/95 backdrop-blur-xl border border-slate-700/50 text-white rounded-2xl shadow-2xl z-50 overflow-hidden`}
                    ...
                    >
                        ...
                        <div className="px-6 py-4 bg-slate-800/50 border-t border-slate-700/50">
                            <div className="flex justify-between items-center">
                                <span className="text-slate-400 text-xs">© 2025 Bluelink BPO. Todos los derechos reservados</span>
                            </div>
                        </div>
